        ...
        <div class="mainAbout">
            ...
            <div class="mainQA">
                <div class="QA">
                    ...
                    <div class="textbox">
                        <p> The RoAM framework is used to to measure success against a particular goal and compare across different ways of achieving that goal to see which performs best. It is a custom-built indicator constructed following a particular structural framework. It can be used in any field that requires comparisons of goal achievement across heterogenous datasets.
                        </p>
                        </p>
                    </div>
                </div>
                ...
                <div class="QA">
                    ...
                    <div class="textbox">
                        ...
                        <ul>
                            ...
                            <li>Encompass many criteria with differing importance
                            </li>
                            <li>Compare across aggragate datasets and don't have access to the original datasets
                            </li>        
                             <li>Compare goal achievement across highly heterogenous datasets
                            </li>        
                        </ul>
                    </div>
                </div>
